...
bisal_channel = "https://telegram.me/EliteZone_Movies"
bisal_grp = "https://t.me/+wlLlqYtwvAc5ZTk1"
...
class Var(object):
    ...
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1002272613820'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://Koi:Lok@cluster0.bt8r7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'))
